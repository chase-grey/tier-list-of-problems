...
interface BucketColumnProps {
  ...
  readOnly?: boolean; // Whether the component is in read-only mode
}

/**
 * Represents a tier bucket column in the voting board
 */
const BucketColumn = ({ tier, pitches, votes, onAppetiteChange, columnCount = 9, userRole, readOnly = false }: BucketColumnProps) => {
